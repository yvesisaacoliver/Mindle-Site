/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: b30069bf1f5f66a1a19ec95667693fd5)
// Runtime types generated with workerd@1.20260617.1 2025-06-01 nodejs_compat
interface __BaseEnv_CloudflareEnv {
	PEDIDOS: KVNamespace;
	ASSETS: Fetcher;
	INFINITEPAY_HANDLE: string;
	INFINITEPAY_API_BASE: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "INFINITEPAY_HANDLE" | "INFINITEPAY_API_BASE" | "NOTIFICATION_EMAIL" | "GMAIL_APP_PASSWORD">> {}
}
